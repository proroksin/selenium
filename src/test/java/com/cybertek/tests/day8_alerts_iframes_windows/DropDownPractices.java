...
public class DropDownPractices {
    ...
    public void p7_month_dropdown_default_value_test(){
        ...
        //This line gets all of the options from the dropdown and store the value in the list
        List<WebElement> actualMonthOptions = monthDropdown.getOptions();

        //Creating a list of string to store the months
        List<String> expectedMonthOptions = Arrays.asList("January","February","March","April","May","June","July","August",
                "September","October","Novemebr","December");

        //Create a new list of strings and store the texts of the web elements into this new list
